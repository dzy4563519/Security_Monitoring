...
QT_MOC_LITERAL(3, 16, 3) // "img"

    },
    "Decode\0sendImg\0\0img"
};
...
void Decode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Decode::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Decode::sendImg)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Decode::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Decode.data,
...
// SIGNAL 0
void Decode::sendImg(QImage _t1)
{
